...
int script_context_init(qjs::Context &context)
{
    try
    {
        ...
        module.class_<Proxy>("Proxy")
            ...
            .fun<&Proxy::TailscaleAuthKey>("TailscaleAuthKey")
            .fun<&Proxy::TailscaleStateDir>("TailscaleStateDir")
            .fun<&Proxy::TailscaleEphemeral>("TailscaleEphemeral")
            .fun<&Proxy::TailscaleAcceptRoutes>("TailscaleAcceptRoutes")
